                ...
                <div className="row py-4">
                        ...
                        <div className="why-card">
                            ...
                            <div className="card-content">
                                <div className="icon-circle">
                                    <img loading='lazy' src={userIcon} alt="icon" className="" width='21.24px' height='21.24px' />
                                </div>
                    ...
                    <div className="col-md-4 col-sm-12 my-4">
                        <div className="why-card">
                            <div className="card-content">
                                <div className="icon-circle">
                                    <img loading='lazy' src={bookIcon} alt="icon" className="" width='21.24px' height='21.24px' />
                                </div>
                    ...
                    <div className="col-md-4 col-sm-12 my-4">
                        <div className="why-card">
                            ...
                            <div className="card-content">
                                <div className="icon-circle">
                                    <img loading='lazy' src={usersIcon} alt="icon" className="" width='21.24px' height='21.24px' />
                                </div>
                    ...
                    <div className="col-md-6 col-sm-12 my-4 ">
                        <div className="why-card">
                            <div className="card-content">
                                <div className="icon-circle">
                                    <img loading='lazy' src={cpuIcon} alt="icon" className="" width='21.24px' height='21.24px' />
                                </div>
                    ...
                    <div className="col-md-6 col-sm-12 my-4 ">
                        <div className="why-card">
                            <div className="card-content">
                                <div className="icon-circle">
                                    <img loading='lazy' src={brandIcon} alt="icon" className="" width='21.24px' height='21.24px' />
                                </div>
                            ...
                            <div className="flexible-card">
                                ...
                                <div className="diamond-frame">
                                    <img loading='lazy' src={showcaseImg5} alt="img" width='62px' height='62px' className='img-fluid fire-red' />
                                    {/* <img loading='lazy' src={showcaseImg5_b} alt="img" width='65px' height='65px' className='img-fluid fire-white' /> */}
                                </div>
                            </div>
                        </div>
                    </div>
